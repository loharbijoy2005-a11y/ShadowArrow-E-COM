...
func GoogleSync(cfg *config.Config) gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if phoneUserFound {
			...
			if phoneUser.Email != "" && !strings.HasSuffix(phoneUser.Email, "@omnikart.in") && !strings.HasSuffix(phoneUser.Email, "@shadowarrow.in") && !strings.HasSuffix(phoneUser.Email, "@shadowarrow.com") && phoneUser.Email != payload.Email {
